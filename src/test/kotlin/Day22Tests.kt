...
class Day22Tests {
    ...
    private val inputLinesB = listOf(
        "on x=10..12,y=10..12,z=10..12",
        "on x=11..13,y=11..13,z=11..13",
    ...
    @Test
    fun testParseInputDay22() {
        val instructions1 = parseInputDay22(inputLines1)
        assertEquals(Instruction(true,11..13,11..13,11..13), instructions1[1])
        val instructions2 = parseInputDay22(inputLines2)
        assertEquals(Instruction(true, -46..7,-6..46,-50..-1), instructions2[3])
        assertEquals(Instruction(false, -48..-32,26..41,-47..-37), instructions2[10])
    }
    ...
    fun testCountCubesOnInLimitedRange() {
        ...
        val instructions2 = parseInputDay22(inputLines2)
        assertEquals(590784, cubesOnAfterInstructions1(instructions2))
    }

    @Test
    fun testCountCubesOnInFullRangeA() {
        val instructionsA = parseInputDay22(inputLinesA)
        assertEquals(46L, cubesOnAfterInstructions2(instructionsA))
    }

    @Test
    fun testCountCubesOnInFullRangeB() {
        val instructionsB = parseInputDay22(inputLinesB)
        assertEquals(46L, cubesOnAfterInstructions2(instructionsB))
    }
    ...
    @Test
    fun testCountCubesOnInFullRange1() {
        val instructions1 = parseInputDay22(inputLines1)
        assertEquals(39, cubesOnAfterInstructions2(instructions1))
    }

    @Test
    fun testCountCubesOnInFullRange2() {
        val instructions3 = parseInputDay22(inputLines3)
        assertEquals(2758514936282235, cubesOnAfterInstructions2(instructions3))
    }
}